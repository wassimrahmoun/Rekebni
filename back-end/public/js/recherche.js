const ajouterresultat = function (nbrtrajet, mesDonnees) {
...
//  commencer le chargement de la page
const profilePic = document.querySelector(".profile-pic");
const prixbas = document.getElementById(".filter-price");
document.addEventListener("DOMContentLoaded", function () {
  const trajetbox = document.querySelector(".search-results");
  const mesDonnees = JSON.parse(localStorage.getItem("mes-donnees"));
  console.log(mesDonnees);
  var selectedPassengers = localStorage.getItem("selectedPassengers");
  console.log("Nombre de passagers récupéré : " + selectedPassengers);
...
<span class="amount-of-results-text">Résultats</span>
  ...
  ajouterresultat(nbrtrajet, mesDonnees);
});
